...
# Usage functions
def process_single_user(user_id: str, text: str, user_name: str,channel_id:str,job_id: str | None = None, slack_handler=None) -> dict:
    """ 
    ...
    """
    try:
        # Remove the 100 mili second sleep that was causing issues
        # time.sleep(100)  # Commented out
        ...
        unwanted_keys = ['formatted_query', 'chat_context', 'rag_answer','source_documents','job_id`']
        result = {k: v for k, v in result.items() if k not in unwanted_keys}
