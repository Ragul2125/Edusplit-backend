    ...
    client.chat_postMessage(
        ...
        blocks=[
            ...
            },
            {
                ...
                "elements": [
                    {"type": "button", "text": {"type": "plain_text", "text": "Yes,Post it"}, "action_id": "approve"},
                    {"type": "button", "text": {"type": "plain_text", "text": "No,Discard it"}, "action_id": "reject"},
                    {"type": "button", "text": {"type": "plain_text", "text": "Edit"}, "action_id": "edit"},
                    {"type": "button", "text": {"type": "plain_text", "text": "Move it to draft"}, "action_id": "draft_opt"},
