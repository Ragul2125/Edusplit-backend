    ...
    try:
        if delete_match:
            ...
            if target_job:
                ...
                user_name=target_job.get('user_name',"null")
                channel_id = target_job.get('channel_id','null')
                description = target_job.get('description', 'No description available')
                job_title = target_job.get('job_title', 'No job title available')
    ...
    for list_item in data:
        ...
        try:
            ...
            if intent == 'past_request':
                ...
                threading.Thread(target=handle_hiring_request, args=(response_dict, list_item, slack_handler)).start()
