...
def create_draft_table():
 ...
 ## do not add unessary columns remove all -------------------------------------------------
def insert_draft(job_id, user_id, username, channel_id, job_title, description):
    ...
    try:
        ...
        cursor.execute("""
            INSERT INTO drafts (
                job_id, user_id, username, channel_id, job_title,description, timestamp
            ) VALUES (?, ?, ?, ?, ?, ?, ?)
        """, (
            job_id,
            user_id,
